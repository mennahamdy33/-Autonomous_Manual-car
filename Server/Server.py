...
class HandCodedLaneFollower(object):
    ...
    def steer(self, frame, lane_lines):
        ...
        curr_heading_image = display_heading_line(frame, self.curr_steering_angle,len(lane_lines))
...
def display_heading_line(frame, steering_angle,numberOflines, line_color=(0, 0, 255), line_width=5, ):
    ...
    if((( steering_angle==89 ) and (numberOflines ==1)) or (0 <= steering_angle < 85)):
        print(' Left')
        DirectionSendToServer.append('l')
        print('l')
# or (streeung_angle == 95) and numberOfLines ==2
    elif ((85  <= steering_angle <= 92) and( numberOflines==2)):
        DirectionSendToServer.append('f')
        print('f')

    elif ((92 < steering_angle <= 180) or (steering_angle == 91 and numberOflines==1 )):
        DirectionSendToServer.append('r')
        print('r')
    else:

        print('s')
        DirectionSendToServer.append('s')
...
if __name__ == '__main__':
    ...
    id = [None]
    app.run(debug=True, host='172.28.133.173')
